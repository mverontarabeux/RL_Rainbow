...
class PrioritizedReplayBuffer(ReplayBuffer):
    def __init__(self, capacity, batch_size, alpha: float = 0.6):
...
class prioDQN:
    def __init__(self, state_dim, action_dim, cfg):
        ...
        self.memory = PrioritizedReplayBuffer(cfg.memory_capacity, cfg.batch_size, cfg.alpha)  # experience replay
    ...
    def update(self):
        ...
        elementwise_loss = nn.MSELoss(reduction='none')(q_values, expected_q_values.unsqueeze(1))
...
def env_agent_config(data, cfg, mode):
    ...
    agent = prioDQN(cfg.state_space_dim, cfg.action_space_dim, cfg)
...
class Config:
    ...
    def __init__(self):
        ################################## env hyperparameters ###################################
        self.algo_name = 'prioDQN' # algorithmic name
